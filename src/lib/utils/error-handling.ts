...
/**
 * Enhanced error handling utilities to properly capture and serialize Supabase errors
 */
...
/**
 * Enhanced logging function that properly handles all error types
 */
...
/**
 * Enhanced database operation wrapper with proper error handling
 */
