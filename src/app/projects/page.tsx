...
function ProjectsPage() {
  ...
  const handleCreateProject = async () => {
    console.log(
      "[ProjectsPage] handleCreateProject called, isCreatingProject:",
      isCreatingProject
    );

    if (isCreatingProject) {
      console.log(
        "[ProjectsPage] Project creation already in progress, ignoring click"
      );
    ...
    try {
      ...
      if (result.success && result.project) {
        ...
        console.log(
          "[ProjectsPage] Replacing URL with real project ID:",
          realUrl
        );
